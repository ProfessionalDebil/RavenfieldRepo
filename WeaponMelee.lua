behaviour("WeaponMelee")

function WeaponMelee:Start()
...
function WeaponMelee:Melee()
    ...
    local randomInt = Mathf.RoundToInt(Random.Range(0, self.meleeAnimationsCount))
    self.animator.SetInteger("meleeInt", randomInt)
